...
export EXPORT_MAP_S3_BUCKET="$(aws secretsmanager get-secret-value --secret-id EXPORT_MAP_S3_BUCKET | jq -r .SecretString | jq fromjson | jq -r .EXPORT_MAP_S3_BUCKET)"
