import { isBlankScreenshot } from './capture-utils';

const WHITE_JPEG_BASE64 =
...
const BLACK_JPEG_BASE64 =
  '';

describe('capture utils', () => {
  describe('isBlankScreenshot()', () => {
    it('treats a mostly white screenshot as blank', async () => {
      await expect(isBlankScreenshot(WHITE_JPEG_BASE64)).resolves.toBe(true);
    });

    it('does not treat a dark screenshot as blank', async () => {
      await expect(isBlankScreenshot(BLACK_JPEG_BASE64)).resolves.toBe(false);
    });
  });
});
